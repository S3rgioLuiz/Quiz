                    ...
                    <div class="row justify-content-center modulo">
                        <div class="col-6 align-self-center">
                            ...
                            <form method="post" action="includes/logica/logica.php" enctype="multipart/form-data">
                                ...
                                <input type="text" name="nome" class="nome2" placeholder="DIGITE O NOME" value="<?php echo $modulo["nome"] ?>">
                                <label for="arquivo2" class="arquivo-label">Trocar Foto</label>
                                <input type="file" name="arquivo" id="arquivo2" class="arquivo2">
                                <textarea maxlength="255" rows="5" cols="40" 
                                    placeholder="DIGITE A DESCRIÇÃO"
                                    name="descricao" class="descricao2"><?php echo $modulo["descricao"]; ?></textarea>
